...
import { titlePaddingVertical } from "../../CoolScrollView/styles";
...
export default class Agenda extends Component<AgendaProps, State> {
	...
	constructor(props: AgendaProps) {
		...
		this.reservationsList = props.reservationsList;
	}
	...
	renderReservations() {
		if (this.reservationsList) return this.reservationsList;
	...
	renderWeekNumbersSpace = () => {
		return (
			this.props.showWeekNumbers && <View style={this.style.dayHeader} />
		);
	};
	...
	render() {
		...
		return (
			<Animated.View
				...
				style={[this.style.container, o]}
			>
				<View
					style={[
						this.style.reservations,
